  ...
  return (
    <React.Fragment>
      <a
        ...
        href={`https://facebook.com/sharer/sharer.php?u=${urlOrigin}/article${slug}`}
        target="_blank"
      ...
      <a
        className="resp-sharing-button__link"
        href={`https://twitter.com/intent/tweet/?url=url=${urlOrigin}/article${slug}`}
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Twitter"
      >
      ...
      <a
        className="resp-sharing-button__link"
        href={`https://www.linkedin.com/shareArticle?mini=true&url=${urlOrigin}/article${slug}&title=${title}`}
        target="_blank"
        rel="noopener noreferrer"
        aria-label="LinkedIn"
      >
